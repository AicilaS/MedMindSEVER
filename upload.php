...
if (is_uploaded_file($file1['tmp_name'])) {
    if (move_uploaded_file($file1['tmp_name'], $target_file)) {
			$command = escapeshellcmd("/Library/Frameworks/Python.framework/Versions/3.7/bin/python3 /Users/jerdFloder/Desktop/SeverMedMind/NormalClassify.py /Users/jerdFloder/Desktop/SeverMedMind/uploads/". basename($_FILES["imageUpload"]["name"])) ;
